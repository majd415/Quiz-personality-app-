...
class UploadControllerDominantPositive extends GetxController {
  UploadControllerDominantPositive({required this.uploadUrl});
...
class UploadControllerDominantNegative extends GetxController {
  UploadControllerDominantNegative({required this.uploadUrl});
