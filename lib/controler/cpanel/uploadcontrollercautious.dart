...
class ControllerDominantPositiveCautious extends GetxController {
  ControllerDominantPositiveCautious({required this.uploadUrl});
...
class ControllerDominantNegativeCautious extends GetxController {
  ControllerDominantNegativeCautious({required this.uploadUrl});
