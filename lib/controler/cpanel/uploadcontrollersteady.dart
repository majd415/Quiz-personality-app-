...
class ControllerDominantPositiveSteady extends GetxController {
  ControllerDominantPositiveSteady({required this.uploadUrl});
...
class ControllerDominantNegativeSteady extends GetxController {
  ControllerDominantNegativeSteady({required this.uploadUrl});
